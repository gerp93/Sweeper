...
// Formerly the standalone "Projections" page -- now nested as the "Income Projections" tab
// under the Projections page, alongside Balloon Payments and Recurring Bills. Keeps its own
// heavy state/loading entirely self-contained rather than being folded into the parent.
