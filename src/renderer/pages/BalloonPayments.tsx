...
// Formerly the standalone "Obligations" page -- now nested as the "Balloon Payments" tab under
// the Obligations page, alongside Recurring Bills. Keeps its own heavy CRUD state/loading
// entirely self-contained rather than being folded into the parent, since it's a full page's
// worth of logic in its own right.
