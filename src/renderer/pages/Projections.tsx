...
// The month-by-month forecast (chart + burn-rate controls) always reflects all three inputs --
// income, obligations, recurring bills -- at once, so it stays visible regardless of which tab
// is selected below it. The tab bar only switches which list you're managing (Income
// Projections, Balloon Payments, Recurring Bills), not the forecast itself.
  ...
  return (
    <div>
      ...
      <p className="text-muted" style={{ marginTop: -8, fontSize: 13, maxWidth: 720 }}>
        A rough projected balance at a future date, blending pencilled-in income, balloon payment
        obligations, and recurring bills. Everything below is an estimate based on what you enter, not a
